...
public class CheckinVerificatinRequest {
	public static void main(String[] args) throws JSONException, IOException, ParseException, FodelAPIException{
		...
		JSONObject jsonObject = HttpRequestUtil.request("POST", "http://api.test.fo-del.com/shipment/checkInVerificationRequest", JSONObject.toJSONString(params));
