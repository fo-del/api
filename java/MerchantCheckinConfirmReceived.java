...
public class MerchantCheckinConfirmReceived {
	public static void main(String[] args) throws JSONException, IOException, ParseException, FodelAPIException{
		...
		params.put("awbs", "2480073675,2480073708");
		...
		JSONObject jsonObject = HttpRequestUtil.request("POST", "/shipment/merchantCheckinConfirmReceived", paramJson);
